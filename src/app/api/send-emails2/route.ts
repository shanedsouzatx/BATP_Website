...
export async function POST(request: Request) {
  try {
    ...
    const locationEmails: Record<string, string> = {
      ...
      "Bala Cynwyd Office": "Joanna.Vazquez@batp.org",

      // "Philadelphia Office": "samantha.power@batp.org",
      "Philadelphia Office": "Joanna.Vazquez@batp.org",
      // "South Philadelphia Satellite Office": "williampower@batp.org",
      "South Philadelphia Satellite Office": "Joanna.Vazquez@batp.org",
    };

    const location = formData.get('location') as string;
    const recipientEmail = locationEmails[location] || "Joanna.Vazquez@batp.org"; //williampower@batp.org
