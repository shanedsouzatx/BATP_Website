...
const Hero2: React.FC = () => {
  return (
    <section className="min-h-screen pt-11 mdLpt-20 flex p-3 md:p-7 hidden md:flex">
      ...
      <div className="w-1/2 hidden md:block">
       ...
       Leadership Team
        ...
        <h2 className="text-3xl -mt-[20px] lg:-mt-0 md:text-4xl text-black font-bold mb-4">
          <strong>
        ...
        {/*  */}
        <h2 className="text-3xl font-bold">Gary Ames, MA, MBA, BCN.
...
<Link href="https://www.CalmFocus.com" className="text-blue-500 hover:text-blue-700">www.CalmFocus.com</Link>
        ...
        {/*  */}
        <h2 className="text-3xl font-bold">Halina Dziewolska M.Ed., M.S.Ed., LBS, BCBA
        ...
        </p><h2 className="text-3xl font-bold">Lynn Santilli Connor, LCSW, BCBA
