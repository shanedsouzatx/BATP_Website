...
export default function Benefits() {
  return (
   ...
   <h2 className="text-xl md:text-2xl font-bold text-blue-500    ">Benefits of Working with Us
     ...
     <h1 className="text-blue-500 text-xl sm:text-2xl md:text-4xl  font-bold pt-16"> <Link href="/job-application" className="ttext-xl md:text-2xl font-bold text-blue-500 "> Join Our Team Click Here </Link></h1>
